                    ...
                    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
                            <div className="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
                                <img alt="Party" src={data?.image} className="absolute inset-0 h-full w-full object-cover" style={{ minHeight: 600 }} />
                            </div>
                            <div className="lg:py-24">
                                ...
                                />
                                <h1 className="text-3xl font-bold sm:text-4xl font-givenget">{data?.user_name} completed</h1>
                                <h2 className="text-2xl font-bold sm:text-3xl text-orange-500 font-givenget">
                                    {data?.title}
                                </h2>
